...
const mockStores: Record<string, { name: string; email: string; id: number }> = {
  ...
  "2": { id: 2, name: "Le Marché des Professionnels", email: "NOOR EATpro@gmail.com" },
  "3": { id: 3, name: "Service Traiteur", email: "NOOR EATtraiteur@gmail.com" },
  "4": { id: 4, name: "France Mangasin test", email: "ndame.kital@lNOOR EAT.com" },
