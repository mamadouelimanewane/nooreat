...
import { setDriverSession } from "@/lib/driverSession"
import { DRIVER_SESSION_EVENT } from "../layout"
    ...
    <div className="ne-login-bg">
      <div style={{ width: "100%", maxWidth: "400px" }}>
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          <p style={{ color: "var(--ne-text-secondary)", fontSize: "13px" }}>Espace livreur</p>
        </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input className="ne-input" style={{ paddingLeft: "36px" }} value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="driver@nooreat.com" />
              </div>
            </div>
            <div>
