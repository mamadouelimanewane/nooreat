...
const mockData = [
  { id: "TX-U001", user: "Fatou Diallo", phone: "+221776543210", type: "Crédit", amount: 500, method: "Cash", desc: "Recharge manuelle", balance: 500, date: "2026-03-14 10:00", status: "Completed" },
  { id: "TX-U002", user: "Fatou Diallo", phone: "+221776543210", type: "Débit", amount: 200, method: "App", desc: "Paiement commande #3240", balance: 300, date: "2026-03-14 11:30", status: "Completed" },
  { id: "TX-U003", user: "Moussa Sarr", phone: "+221743210987", type: "Crédit", amount: 1000, method: "Wave", desc: "Remboursement commande", balance: 1000, date: "2026-03-12 09:00", status: "Pending" },
  { id: "TX-U004", user: "Aissatou Ba", phone: "+221700001234", type: "Débit", amount: 750, method: "App", desc: "Paiement commande #3180", balance: 250, date: "2026-03-10 16:00", status: "Completed" },
]

export default function UserWalletTransactionsPage() {
  const [search, setSearch] = useState("")
  const filtered = mockData.filter(t => !search || t.user.toLowerCase().includes(search.toLowerCase()))

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-semibold text-gray-700 flex items-center gap-2">
          👤 Transactions portefeuille — Utilisateurs
        </h1>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              {["N°", "ID Transaction", "Utilisateur", "Téléphone", "Type", "Montant (FCFA)", "Méthode", "Description", "Solde après", "Date", "Statut"].map(h => (
